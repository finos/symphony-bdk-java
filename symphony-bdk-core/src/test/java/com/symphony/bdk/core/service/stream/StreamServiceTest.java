...
public class StreamServiceTest {
  ...
  void searchRoomsTest() throws IOException {
    this.mockApiClient.onPost(V3_ROOM_SEARCH, ResResponseHelper.readResResponseFromClasspath("/stream/room_search.json"));
  ...
  void searchRoomsTestFailed() {
    this.mockApiClient.onPostFailed(400, V3_ROOM_SEARCH, "{}");
  ...
  void getRoomInfoTest() throws IOException {
    this.mockApiClient.onGet(V3_ROOM_INFO.replace("{id}", "bjHSiY4iz3ar4iIh6-VzCX___peoM7cPdA"), ResResponseHelper.readResResponseFromClasspath("/stream/v3_room_detail.json"));
  ...
  void getRoomInfoTestFailed() {
    this.mockApiClient.onGetFailed(400, V3_ROOM_INFO.replace("{id}", "bjHSiY4iz3ar4iIh6-VzCX___peoM7cPdA"), "{}");
  ...
  void setRoomActiveTest() throws IOException {
    this.mockApiClient.onPost(V1_ROOM_SET_ACTIVE.replace("{id}", "HNmksPVAR6-f14WqKXmqHX___qu8LMLgdA"), ResResponseHelper.readResResponseFromClasspath("/stream/room_detail.json"));
  ...
  void setRoomActiveTestFailed() {
    this.mockApiClient.onPostFailed(400, V1_ROOM_SET_ACTIVE.replace("{id}", "HNmksPVAR6-f14WqKXmqHX___qu8LMLgdA"), "{}");
  ...
  void updateRoomTest() throws IOException {
    this.mockApiClient.onPost(V3_ROOM_UPDATE.replace("{id}", "bjHSiY4iz3ar4iIh6-VzCX___peoM7cPdA"), ResResponseHelper.readResResponseFromClasspath("/stream/v3_room_detail.json"));
  ...
  void updateRoomTestFailed() {
    this.mockApiClient.onPostFailed(400, V3_ROOM_UPDATE.replace("{id}", "bjHSiY4iz3ar4iIh6-VzCX___peoM7cPdA"), "{}");
  ...
  void listStreamsTest() throws IOException {
    this.mockApiClient.onPost(V1_STREAM_LIST, ResResponseHelper.readResResponseFromClasspath("/stream/list_stream.json"));
  ...
  void listStreamsTestFailed() {
    this.mockApiClient.onPostFailed(400, V1_STREAM_LIST, "{}");
  ...
  void getStreamInfoTest() throws IOException {
    this.mockApiClient.onGet(V2_STREAM_INFO.replace("{sid}", "p9B316LKDto7iOECc8Xuz3qeWsc0bdA"), ResResponseHelper.readResResponseFromClasspath("/stream/v2_stream_attributes.json"));
  ...
  void getStreamInfoTestFailed() {
    this.mockApiClient.onGetFailed(400, V2_STREAM_INFO.replace("{sid}", "p9B316LKDto7iOECc8Xuz3qeWsc0bdA"), "{}");
  ...
  void getAttachmentsOfStreamTest() throws IOException {
    this.mockApiClient.onGet(V1_STREAM_ATTACHMENTS.replace("{sid}", "1234"), ResResponseHelper.readResResponseFromClasspath("/stream/list_attachments.json"));
  ...
  void getAttachmentsOfStreamTestFailed() {
    this.mockApiClient.onGetFailed(400, V1_STREAM_ATTACHMENTS.replace("{sid}", "1234"), "{}");
  ...
  void setRoomActiveAdminTest() throws IOException {
    this.mockApiClient.onPost(V1_ROOM_SET_ACTIVE_ADMIN.replace("{id}", "HNmksPVAR6-f14WqKXmqHX___qu8LMLgdA"), ResResponseHelper.readResResponseFromClasspath("/stream/room_detail.json"));
  ...
  void setRoomActiveAdminTestFailed() {
    this.mockApiClient.onPostFailed(400, V1_ROOM_SET_ACTIVE_ADMIN.replace("{id}", "HNmksPVAR6-f14WqKXmqHX___qu8LMLgdA"), "{}");
  ...
  void listStreamsAdminTest() throws IOException {
    this.mockApiClient.onPost(V2_STREAM_LIST_ADMIN, ResResponseHelper.readResResponseFromClasspath("/stream/v2_admin_stream_list.json"));
  ...
  void listStreamAdminTestFailed() {
    this.mockApiClient.onPostFailed(400, V2_STREAM_LIST_ADMIN, "{}");
  ...
  void listStreamMembersTest() throws IOException {
    this.mockApiClient.onGet(V1_STREAM_MEMBERS.replace("{id}", "1234"), ResResponseHelper.readResResponseFromClasspath("/stream/v2_membership_list.json"));
  ...
  void listStreamMembersTestFailed() {
    this.mockApiClient.onGetFailed(400, V1_STREAM_MEMBERS.replace("{id}", "1234"), "{}");

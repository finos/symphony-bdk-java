...
public class MessageService extends OboMessageService implements OboService<OboMessageService> {
  ...
  private MessageService(
    ...
    super(messagesApi, authSession, retryBuilder, templateResolver);
  ...
  public OboMessageService obo(AuthSession oboSession) {
    return new OboMessageService(this.messagesApi, oboSession, this.retryBuilder, templateResolver);
  }

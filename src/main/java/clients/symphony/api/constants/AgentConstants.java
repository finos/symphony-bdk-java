...
public class AgentConstants {
    ...
    public static final String CREATEFIREHOSEV5 = AGENT + "/v5/firehose/create";
    public static final String LISTFIREHOSEV5 = AGENT + "/v5/firehose/list";
    public static final String READFIREHOSEV5 = AGENT + "/v5/firehose/{id}/read";
    public static final String DELETEFIREHOSEV5 = AGENT + "/v5/firehose/{id}/delete";
